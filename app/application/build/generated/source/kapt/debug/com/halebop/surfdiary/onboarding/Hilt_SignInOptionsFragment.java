 ...
 */
public abstract class Hilt_SignInOptionsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SignInOptionsFragment() {
    super();
  }

  Hilt_SignInOptionsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SignInOptionsFragment_GeneratedInjector) this.generatedComponent()).injectSignInOptionsFragment(UnsafeCasts.<SignInOptionsFragment>unsafeCast(this));
    }
  }
